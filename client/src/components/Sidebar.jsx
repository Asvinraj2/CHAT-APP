...
const Sidebar = () => {
    ...
    // FIX 1: Create proper handler functions
    const handleLogout = () => {
        logout();
    };
        ...
        <div className={`bg-[#8185b2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden " : ""} `} >
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='relative py-2 group'>
                        ...
                        <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block'>
                            {/* FIX 2: Use proper onClick handlers */}
                            <p onClick={handleProfileEdit} className='cursor-pointer text-sm'>Edit Profile</p>
            ...
            <div className='flex flex-col'>
                {filteredUser.map((user, index) => (
                    ...
                    >
                        <img src={user?.profilePic || assets.avatar_icon} alt='image' className='w-[35px] aspect-[1/1] rounded-full' />
